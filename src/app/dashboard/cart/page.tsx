            ...
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:px-0">
                ...
                <form className="mt-12">
                    ...
                    <section aria-labelledby="summary-heading" className="mt-10">
                        ...
                        <div className="mt-10">
                            <div className="w-full rounded-md border border-transparent bg-indigo-600 px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50">
                                <Link
