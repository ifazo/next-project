...
export default function Checkout() {
  return (
    <div className="bg-white">
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-x-8 lg:grid-cols-2 lg:px-8 xl:gap-x-16">
      ...
      <div className="mx-8 border-t border-gray-200 py-16 pt-6 sm:flex sm:items-center sm:justify-between">
        <button
          type="submit"
